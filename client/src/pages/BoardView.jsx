    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="pt-12">
        <div className="px-4 py-3 flex items-center gap-3 border-b border-white/5">
          <div className="w-4 h-4 rounded" style={{ background: board.color || 'var(--accent-indigo)' }} />
          <h1 className="text-base font-bold" style={{ color: 'var(--text-primary)' }}>{board.title}</h1>
        </div>
      </div>
        ...
        <Droppable droppableId="board" direction="horizontal" type="LIST">
          {(provided) => (
            <div
              ...
              style={{ minHeight: 'calc(100vh - 108px)', paddingTop: '16px' }}
            >
              ...
              <div className="flex-shrink-0 w-72">
                {addingList ? (
                  ...
                  <button
                    ...
                    className="w-full rounded-xl px-4 py-3 text-sm font-medium text-left transition-all flex items-center gap-1.5 border border-dashed border-white/10 hover:border-white/20"
